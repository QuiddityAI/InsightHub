    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extraction_answers', models.JSONField(blank=True, default=dict, null=True, verbose_name='Extraction Answers')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('changed_at', models.DateTimeField(auto_now=True, verbose_name='Changed at')),
                ('is_public', models.BooleanField(default=False, verbose_name='Is public')),
                ('source_plugin', models.CharField(choices=[('INTERNAL_OPENSEARCH_QDRANT', 'Internal DB (OpenSearch + Qdrant)'), ('BRAVE_WEB_API', 'Brave Web Search API'), ('BING_WEB_API', 'Bing Web Search API'), ('SEMANTIC_SCHOLAR_API', 'Semantic Scholar API')], default='INTERNAL_OPENSEARCH_QDRANT', max_length=50, verbose_name='Source Plugin')),
                ...
                ('collection_item_rendering', models.JSONField(blank=True, default=data_map_backend.models.get_default_collection_item_rendering, null=True, verbose_name='Collection List Rendering')),
