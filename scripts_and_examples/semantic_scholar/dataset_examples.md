...
```json
{
  ...
  "abstract": "After a preliminary analysis of the procedure, functions and flaws of land expropriation policies of Anhui Province, the paper discusses through many cases the land expropriation procedures in different stages such as preliminary stage, submission-for-approval stage and execution stage, and explores the land expropriation system and cost prestore system as well. The paper concludes with pointing out the flaws in the execution procedure of land expropriation in Anhui Province and putting forward some suggestions accordingly."
}
```
...
```json
{
  "corpusid": 71102255,
  "model": "tldr@v2.0.0",
  "text": "The case of a 58-year-old female with an oral osteolipoma is presented and Radiographic and histological features are discussed, along with a differential diagnosis and review of the literature."
}
```
...
```json
{
  ...
  "externalids": {
    ...
    "CorpusId": "19730001",
    "PubMed": "27223548",
    "DOI": "10.7748/ns.4.4.26.s52",
    "PubMedCentral": null
  },
  "url": "https://www.semanticscholar.org/paper/7cf79fbdfa2160c3e8e16b4c3a13cdd56e148031",
  "title": "Identifying and protecting patients who may get pressure sores.",
  "authors": [
    {
      "authorId": "48687004",
      "name": "P. Lowthian"
  ...
  "venue": "Nursing Standard",
  "publicationvenueid": "391d7238-99ed-43e0-a3bc-f767bcd09236",
  "year": 1989,
  "referencecount": 0,
  "citationcount": 20,
  ...
  "publicationdate": "1989-10-24",
  "journal": {
    "name": "Nursing standard (Royal College of Nursing (Great Britain) : 1987)",
    "pages": "\n          26-9\n        ",
    "volume": "4 4"
  }
}
