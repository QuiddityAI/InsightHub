# Generated by Django 4.2.4 on 2023-08-25 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('collection_list_rendering', models.TextField(blank=True, null=True, verbose_name='Rendering (Collection List)')),
                ('detail_view_rendering', models.TextField(blank=True, null=True, verbose_name='Rendering (Detail View)')),
                ('hover_label_rendering', models.TextField(blank=True, null=True, verbose_name='Rendering (Hover Label)')),
                ('result_list_rendering', models.TextField(blank=True, null=True, verbose_name='Rendering (Result List)')),
            ],
            options={
