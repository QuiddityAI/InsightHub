...
class WorkflowMetadata(Schema):
    workflow_id: str
    order: int = 9999
    name1: str = "Unnamed"  # most fields can use <entity_name_singular> and <entity_name_plural> placeholders
    name2: str = "Workflow"  # name1 is the upper part in the UI, name2 is the main part
    help_text: str = ""
    query_field_hint: str = "Your input"
