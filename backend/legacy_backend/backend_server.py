...
@convert_flask_to_django_route(
    "/data_backend/dataset/<int:dataset_id>/<field>/items_having_value_count", methods=["GET"]
)
...
@convert_flask_to_django_route(
    "/data_backend/dataset/<int:dataset_id>/<field>/sub_items_having_value_count", methods=["GET"]
)
