...
def get_kleinanzeigen_results(dataset_id: int, query: str, limit: int, offset: int):
    ...
    for i, item in enumerate(data):
        ...
        item["_origins"] = [
            {"type": "kleinanzeigen", "field": "unknown", "query": query, "score": score, "rank": i + 1}
        ]
        item["_score"] = score
...
def _get_results(
    ...
    url = (
        f"https://www.kleinanzeigen.de/s-suchanfrage.html?keywords={query}&categoryId=&locationStr={location or ''}&locationId=&radius={radius_km}"
