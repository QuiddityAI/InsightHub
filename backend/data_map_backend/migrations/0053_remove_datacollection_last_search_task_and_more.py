    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "settings",
                    models.JSONField(
                        blank=True, default=dict, help_text="Settings for the search task", verbose_name="Settings"
                    ),
                ),
                (
                ...
                (
                    "is_saved",
                    models.BooleanField(
                        default=False, help_text="Whether the search task is saved", verbose_name="Is saved"
                    ),
                ),
                (
                    "run_on_new_items",
                ...
                (
                    ...
                    models.DurationField(
                        blank=True, help_text="Interval for periodic runs", null=True, verbose_name="Period interval"
                    ),
                ),
                (
                    "last_run",
                    models.DateTimeField(
                        blank=True, help_text="Last time the search task was run", null=True, verbose_name="Last run"
                    ),
                ),
                (
                    "collection",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="+",
                to="data_map_backend.searchtask",
