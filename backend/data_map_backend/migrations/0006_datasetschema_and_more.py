...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DatasetSchema',
            fields=[
                ('identifier', models.CharField(help_text='Do not change this after being used elsewhere', max_length=200, primary_key=True, serialize=False, unique=True, verbose_name='Identifier')),
                ...
                ('primary_key', models.CharField(blank=True, help_text="If set, this field is used to generate the internal '_id' field consistently, otherwise its a random UUID", max_length=200, null=True, verbose_name='Primary Key')),
                ('thumbnail_image', models.CharField(blank=True, help_text='Should point to a field with an image URL', max_length=200, null=True, verbose_name='Thumbnail Image')),
                ('descriptive_text_fields', models.JSONField(blank=True, default=list, help_text='For Word2Vec, Cluster Titles and more', null=True, verbose_name='Descriptive Text Fields')),
                ('default_search_fields', models.JSONField(blank=True, default=list, help_text='Text or embedding fields (for hybrid search)', null=True, verbose_name='Default Search Fields')),
                ('advanced_options', models.JSONField(blank=True, default=dict, help_text='Advanced options for the dataset, like defaults for map creation etc.', null=True, verbose_name='Advanced Options')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='+', to='data_map_backend.datasetschema', verbose_name='Schemas for User-Created Datasets'),
        ),
        migrations.CreateModel(
            name='DatasetField',
            fields=[
                ...
                ('source_fields', models.JSONField(blank=True, default=list, help_text='List of source field identifiers', null=True, verbose_name='Source Fields Plain')),
                ...
                ('schema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='object_fields', to='data_map_backend.datasetschema', verbose_name='Schema')),
            ],
            options={
