    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dimensions",
                    models.IntegerField(help_text="Vector size of the embedding", verbose_name="Dimensions"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "example_file_url",
                    models.CharField(blank=True, max_length=200, null=True, verbose_name="Example File URL"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(blank=True, default=list, null=True, verbose_name="Extraction Questions"),
                ),
                ("table_columns", models.JSONField(blank=True, default=list, null=True, verbose_name="Table Columns")),
                (
                    "current_extraction_processes",
                    models.JSONField(blank=True, default=list, null=True, verbose_name="Current Extraction Processes"),
                ),
                (
                    "created_by",
                    models.ForeignKey(
                ...
                (
                    "parent_collection",
                    models.ManyToManyField(
                        blank=True, to="data_map_backend.datacollection", verbose_name="Parent Collection"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "date_added",
                    models.DateTimeField(default=django.utils.timezone.now, editable=False, verbose_name="Date added"),
                ),
                ("changed_at", models.DateTimeField(auto_now=True, verbose_name="Changed at")),
                ("is_positive", models.BooleanField(default=True, verbose_name="Is positive")),
                (
                    "classes",
                    models.JSONField(default=data_map_backend.models.class_field_default, verbose_name="Classes"),
                ),
                (
                    "field_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "search_settings",
                    models.JSONField(blank=True, default=dict, null=True, verbose_name="Search Settings"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(blank=True, default=dict, null=True, verbose_name="Source Plugin Parameters"),
                ),
                (
                    "database_name",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(blank=True, null=True, verbose_name="Parameter Description"),
                ),
                (
                    "input_type",
                    models.CharField(
                ...
                (
                    "input_is_array",
                    models.BooleanField(default=False, verbose_name="Input is array / can be multiple"),
                ),
                ...
                (
                    "output_is_array",
                    models.BooleanField(default=False, verbose_name="Output is array / can be multiple"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source_fields",
                    models.ManyToManyField(
                        blank=True, to="data_map_backend.objectfield", verbose_name="Source Fields"
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+",
                        to="data_map_backend.objectfield",
                        verbose_name="Negative Annotation Field",
                    ),
                ),
                (
                    "positive_annotation_field",
                    models.ForeignKey(
                        blank=True,
                        db_constraint=False,
                        help_text="binary: bool field, exclusive: single tag, non-exclusive: tag array field",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.DO_NOTHING,
                        related_name="+",
                        to="data_map_backend.organization",
                        verbose_name="Organization",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.CharField(
                        editable=False, max_length=50, primary_key=True, serialize=False, verbose_name="ID"
                    ),
                ),
                ("name", models.CharField(max_length=200, verbose_name="Name")),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "identifier",
                    models.CharField(
                        default=data_map_backend.models.get_random_string, max_length=200, verbose_name="Identifier"
                    ),
                ),
                (
                    "field_type",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="data_map_backend.serviceusage",
                        verbose_name="Service Usage",
                    ),
                ),
            ],
